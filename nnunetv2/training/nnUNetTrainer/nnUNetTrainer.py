...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.num_iterations_per_epoch = dataset_json['numTraining']
    ...
    def run_training(self):
        print(f"[INFO] nnUNetTrainer.run_training: num_epochs: {self.num_epochs} num_iterations_per_epoch: {self.num_iterations_per_epoch} numTraining: {self.dataset_json['numTraining']} save_every: {self.save_every}")
        self.on_train_start()
